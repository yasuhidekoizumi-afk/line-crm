    ...
    .prepare(
      `SELECT
         CASE
           ...
           WHEN LOWER(landing_site) LIKE '%utm_source=line&%'
             OR LOWER(landing_site) LIKE '%utm_source=line %'
             OR LOWER(landing_site) LIKE '%utm_source=line'
             OR LOWER(landing_site) LIKE '%utm_medium=line&%'
             OR LOWER(landing_site) LIKE '%utm_medium=richmenu%' THEN 'line'
           WHEN LOWER(landing_site) LIKE '%utm_source=tiktok%' THEN 'tiktok'
           WHEN LOWER(landing_site) LIKE '%utm_source=ig&%'
             OR LOWER(landing_site) LIKE '%utm_source=ig %'
             OR LOWER(landing_site) LIKE '%utm_source=ig'
             OR LOWER(landing_site) LIKE '%utm_source=fb&%'
             OR LOWER(landing_site) LIKE '%utm_source=fb %'
             OR LOWER(landing_site) LIKE '%utm_source=fb'
             OR LOWER(landing_site) LIKE '%utm_source=facebook%'
             OR LOWER(landing_site) LIKE '%utm_source=instagram%'
             OR LOWER(landing_site) LIKE '%utm_source=meta%'
             OR LOWER(landing_site) LIKE '%fbclid=%' THEN 'meta'
           WHEN LOWER(landing_site) LIKE '%utm_source=google%'
             OR LOWER(landing_site) LIKE '%utm_source=adwords%'
             OR LOWER(landing_site) LIKE '%gclid=%' THEN 'google'
           WHEN LOWER(landing_site) LIKE '%utm_source=yotpo%' THEN 'yotpo'
